...
DATABASES = {
    ...
    'db2': {
        ...
        'NAME'     : 'bludb',
        'USER'     : 'fbm40876',
        'PASSWORD' : '3M8QIjLHz4KNYIYN',
        'HOST'     : 'ba99a9e6-d59e-4883-8fc0-d6a8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud',
        'PORT'     : 31321,
        'OPTIONS': {
            'dsn': "DATABASE=bludb;HOSTNAME=ba99a9e6-d59e-4883-8fc0-d6a8c9f7a08f.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=31321;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=fbm40876;PWD=3M8QIjLHz4KNYIYN"
        }
    }
}
